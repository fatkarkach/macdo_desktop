...
public class JDialogViewInvoice extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogViewInvoice(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonViewDetails.setPreferredSize(new java.awt.Dimension(120, 30));
...
//
    ...
    private void selectInvoiceList() {
        ...
        for (Invoice i : invoiceList) {
            tableModel.addRow(new Object[]{i.getId(), i.getUser().getFirstname(), i.getDateTime(), i.getNoOfOrders(), df.format(i.getCustomerCash())});
        }
    }
}
