...
public class JDialogDiscountAU extends javax.swing.JDialog {
     ...
     */
    public JDialogDiscountAU(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal) {
        super(parent, modal);
        this.mainMenu = parent;
        initComponents();
    }

    public JDialogDiscountAU(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
    ...
    public JDialogDiscountAU(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal, String evtl, Discount discount) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        ...
        jTextFieldPercent.setText(String.valueOf(this.discount.getPercentage()));
        jTextArea1.setText(this.discount.getDescription());
        jTextFieldDiscount.setText(this.discount.getDiscount());
        new NumberInput().doubleValidator(jTextFieldPercent);

    }

    public JDialogDiscountAU(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal, Discount discount, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        this.discount = discount;
        ...
        jTextFieldPercent.setText(String.valueOf(discount.getPercentage()));
        jTextArea1.setText(discount.getDescription());
        jTextFieldDiscount.setText(this.discount.getDiscount());
        new NumberInput().doubleValidator(jTextFieldPercent);
    ...
    private void initComponents() {
        ...
        jTextFieldDiscount.setPreferredSize(new java.awt.Dimension(59, 25));
        jPanel2.add(jTextFieldDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 45, 260, 25));
            ...
            switch (this.evt) {
                case "Add":
                    ...
                    if (reply == JOptionPane.YES_OPTION) {
                        discount.setPercentage(Float.parseFloat(jTextFieldPercent.getText()));
                        discount.setDescription(jTextArea1.getText());
                        discount.setDiscount(jTextFieldDiscount.getText());
                        new AppQuery().addDiscount(discount);
                ...
                case "Update":
                    ...
                    if (upate == JOptionPane.YES_OPTION) {
                        ...
                        discount.setPercentage(Float.parseFloat(jTextFieldPercent.getText()));
                        discount.setDescription(jTextArea1.getText());
                        new AppQuery().updateDiscount(discount);
                    }
                    this.dispose();
                    break;
                case "Delete":
                    int response = JOptionPane.showConfirmDialog(null, "Are you sure to delete " + discount.getPercentage() + " " + discount.getDescription() + " ?", "Delete Confirmation!!", JOptionPane.YES_NO_OPTION);
                    if (response == JOptionPane.YES_OPTION) {
                        new AppQuery().deleteDiscount(discount);
                        JOptionPane.showMessageDialog(null, discount.getPercentage() + " " + discount.getDescription() + " is successfully deleted.", "Message", JOptionPane.PLAIN_MESSAGE);
                    }
                    this.dispose();
                    break;
            }
