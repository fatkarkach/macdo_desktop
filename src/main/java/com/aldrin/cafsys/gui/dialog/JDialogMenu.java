...
public class JDialogMenu extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogMenu(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1115, 477));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogMenuAU u = new JDialogMenuAU(mainMenu, true, "Add");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        selectMenu();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogMenuAU u = new JDialogMenuAU(mainMenu, true, "Update", this.menu);
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        selectMenu();
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object categoryl = jTable1.getValueAt(row, 2);
                        Object menul = jTable1.getValueAt(row, 3);
                        Object pricel = jTable1.getValueAt(row, 4);
                        Object ingredientl = jTable1.getValueAt(row, 5);
...
//            column[1].setPreferredWidth(250);
    ...
    private void selectMenu() {
        ...
        for (Menu m : menuList) {
            tableModel.addRow(new Object[]{m.getId(), m.getCategory().getId(), m.getCategory().getCategory(), m.getMenu(), df.format(m.getPrice()), m.getIngredient()});
        }
    }
}
