...
import com.aldrin.cafsys.gui.dialog.au.JDialogTaxAU;
...
public class JDialogTax extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogTax(com.aldrin.cafsys.gui.JFrameCafSys parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogTaxAU u = new JDialogTaxAU(mainMenu, true, "Update", this.tax);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogTaxAU u = new JDialogTaxAU(mainMenu, true, this.tax, "Delete");
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        tax.setId(Integer.parseInt(idl.toString()));
                        tax.setTax(discountl.toString());
                        tax.setPercentage(Float.parseFloat(percentagel.toString()));
                        tax.setDescription(descriptionl.toString());
